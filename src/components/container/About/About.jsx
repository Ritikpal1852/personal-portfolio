  ...
  return (
    <div className="container " id='about'>
      ...
      <div className="about_container">
        ...
        <p>Hello everyone, Myself Ritik Pal, a final year student at IIT Hyderabad. I'm a chemist student but i have deep interest in development. I have made Full stack projects based on Node.js as well as front-end projects based on React.js. Basically A web development enthusiast , learning new skills related to the field of web development. </p>
          {bios.map(bio => {
            return (
